...
import { Friend, Colleague, SecureFriendContact, FriendPartial, EventPass, FriendAndColleagueIntersection } from "./myTypes";
...
): FriendAndColleagueIntersection[] {
  let result: FriendAndColleagueIntersection[] = [];
